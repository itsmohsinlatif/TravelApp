...
<div>
  ...
  {posts.map((post,index)=>{
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-md title-font tracking-widest"style={{color:"white"}}>Travel Pakistan</h2>
      ...
      <p className="leading-relaxed"><strong>Guide Number</strong> : {post.guideNumber}</p>
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">RS-15000</span>
